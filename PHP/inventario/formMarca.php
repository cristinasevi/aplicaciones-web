			...
			<form action="addMarca.php" method="post">
				<div class="form-row">
					<div class="form-group col-md-5">
						...
						<input type="text" name="f_nombremarca" id="f_nombremarca" maxlength="17" class="form-control">
					</div>
				</div>
				<button type="submit" class="btn btn-primary">ENVIAR</button>
				<button type="button" class="btn btn-primary" onclick="window.open('lstMarca.php','_parent')">LISTADO</button>
			</form>
