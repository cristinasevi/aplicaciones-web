		...
		<form action="addDepartamentos.php" method="post">
		  <div class="form-row">
			<div class="form-group col-md-6">
			  ...
			  <input type="text" class="form-control" name="f_departamento" id="f_departamento" maxlenght="50">
			</div>
		  </div>
		
		  
		  <button type="submit" class="btn btn-primary">ENVIAR</button>
		  <button type="button" class="btn btn-primary" onclick="window.open('lstDepartamentos.php', '_parent')">LISTADO</button>
		</form>
