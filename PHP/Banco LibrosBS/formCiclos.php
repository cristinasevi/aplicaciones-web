		...
		<form action="addCiclos.php" method="post">
		  <div class="form-row">
			<div class="form-group col-md-6">
			  <label>Ciclos</label>
			  <input type="text" class="form-control" name="f_ciclo" id="f_ciclo" maxlenght="50">
			</div>
		  </div>
		  <button type="submit" class="btn btn-primary">ENVIAR</button>
		  <button type="button" class="btn btn-primary" onclick="window.open('lstCiclos.php', '_parent')">LISTADO</button>
		</form>
