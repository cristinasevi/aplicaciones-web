  ...
  ?>
	<div class="container">
	  ...
	  <div class="form-group col-8 offset-2"> <!-- 8 columnas y 2 a los lados sin utilizar, en total 12 columnas -->
		...
		<form action="addAutores.php" method="post">
		  <div class="form-row">
			<div class="form-group col-md-6">
			  <label>Autores</label>
			  <input type="text" class="form-control" name="f_autor" id="f_autor" maxlenght="40">
			</div>
		  </div>
		  <button type="submit" class="btn btn-primary">ENVIAR</button>
		  <button type="button" class="btn btn-primary" onclick="window.open('lstAutores.php', '_parent')">LISTADO</button>
		</form>
