...
$sql= "INSERT INTO libros (isbn, titulo, idModulo, idEditorial, idUsuario, precio, vendido, comentarios)
VALUES ('$_POST[f_isbn]', '$_POST[f_titulo]', $_POST[f_idmodulo], $_POST[f_ideditorial], '$_SESSION[usu]', $_POST[f_precio], $_POST[f_vendido], '$_POST[f_comentarios]')"; 
